...
// 1.) (DONE) Create a Menu View on the Main Page that displays all of the Items in the Menu.
     //1.1) (DONE) Items in the Menu should be in a Card Component, it should display the Item Image, Item Price, and Item Name.
     //1.2) (DONE) Each Card should have 1 button to redirect to the Items Details
     //1.3) (DONE) Items that have a quantity of 0 should not be displayed here

// 2.) (DONE) Create an Item Details View that display the Details of the Item such as Img, Price, Category, and a short Description, edit the Items Array to add a short Description of the Item
    //2.1) (DONE) The Item Details Page should have one button to add the Item to the Cart.
    //2.2) (DONE) The Item Details Page should have 2 buttons to either increment or decrement the quantity of the item and an input box in the middle to input quantity
    //2.3) (DONE) The quantity of the item should be reflected in the Cart
    //2.4) (DONE) The quantity of the item should not go below 0, and should not go above the available quantity/stock of the item

// 3.) Create a Cart View Page that displays all of the items the user has added to his Cart.
    //3.1) (DONE) Each Item on the Cart should also be a component that displays the Items Image, Item Name, and Item Price
    //3.2) (DONE) Each Cart Item Card should have 2 buttons to increment or decrement the quantity of the item and an input box in the middle to input quantity
